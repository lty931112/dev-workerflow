...
## 团队协作建议
**文档更新时机**：建议在个人功能分支完成后、提交 PR 前触发文档同步，而非在开发过程中频繁触发
**文档负责人制度**：建议每个迭代指定一名文档负责人，统一执行 doc-generator 的同步更新
**分支策略**：文档更新应跟随功能分支，通过 PR 合并而非直接在主分支更新
**CI 集成**：建议在 CI 中加入文档一致性检查，在 PR 合并时自动触发文档同步